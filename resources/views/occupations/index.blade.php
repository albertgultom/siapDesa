...
<section class="welcome p-t-10">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h3 class="title-5">Master Pekerjaan</h3>
      ...
      <div class="col-md-12">
        <div class="table-responsive m-b-40">
          <div class="table-data__tool">
            ...
            <a href="{{route('occupation.create')}}" class="btn btn-info mt-2 ml-5">Tambah Pekerjaan</a>
            </div>
          </div>
          {{-- <table id="occupationtable"> --}}
          <table id="occupationtable" class="table table-borderless table-data3">
            <thead>
              <tr>
                <th>ID</th>
                <th>Nama</th>
    ...
    columnDefs: [
      ...
      },
      {
        ...
        render: function ( data, type, row, meta ) {
          return '<a href="occupation/'+data+'/edit" class="btn">edit</a>';
        }
      }
    ]
  });
