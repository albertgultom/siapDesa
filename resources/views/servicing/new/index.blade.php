...
<section class="welcome p-t-10">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h3 class="title-5">Pendaftaran Baru</h3>
      ...
      <div class="col-md-12">
        <div class="table-responsive m-b-40">
          <div class="table-data__tool">
            ...
            <a href="{{route('new.create')}}" class="btn btn-info mt-2 ml-5">Tambah Pendaftaran Baru</a>
            </div>
          </div>
    ...
    columnDefs: [
      ...
      },
      {
        ...
        render: function ( data, type, row, meta ) {
          return '<a href="/servicing/edit_new/'+data+'" class="btn">edit</a> <a href="/servicing/verify_new/'+data+'" class="btn">Memproses Berkas</a>';
        }
      }
    ]
  });
